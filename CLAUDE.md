...
**Version**: 2.0 (Intelligent Edition) | **Updated**: 2025-12-06

A modern Litestar fullstack application built with Inertia.js, React 18, and shadcn/ui providing a seamless SPA experience.
...
| Backend | Frontend |
|---------|----------|
| Litestar 2.8+ | React 18 |
| SQLAlchemy 2.0 | Inertia.js |
| advanced-alchemy | shadcn/ui |
| litestar-saq | Tailwind CSS |
| litestar-granian | Vite |
| pytest | Biome |
...
| `app/config.py` | All configuration (Inertia, SAQ, Alchemy) |
