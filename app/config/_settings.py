...
class RedisSettings:
    ...
    _enable_client_memoization: bool = False
    ...
    def get_client(self) -> Redis:
        if not self._enable_client_memoization:
...
class AppSettings:
    ...
    """CSRF Secure Cookie"""
    OPENTELEMETRY_ENABLED: bool = field(default_factory=get_env("OPENTELEMETRY_ENABLED", False))
    """Enable Opentelemetry configuration."""
    LOGFIRE_ENABLED: bool = field(default_factory=get_env("LOGFIRE_ENABLED", False))
