...
class TeamService(service.SQLAlchemyAsyncRepositoryService[m.Team, TeamRepository]):
    """Team Service."""
...
class TeamMemberService(service.SQLAlchemyAsyncRepositoryService[m.TeamMember, TeamMemberRepository]):
    """Team Member Service."""

    repository_type = TeamMemberRepository


class TeamInvitationService(service.SQLAlchemyAsyncRepositoryService[m.TeamInvitation, TeamInvitationRepository]):
