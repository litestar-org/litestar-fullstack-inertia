					...
					<div className="mx-auto max-w-2xl">
						...
						<div className="grid gap-4 sm:grid-cols-2">
							...
							>
								...
								<p className="mt-3 text-sm text-muted-foreground">High-performance Python web framework. Contribute on GitHub.</p>
							</a>

							<a href="https://inertiajs.com/" className="group rounded-xl border bg-card p-6 transition-colors hover:bg-accent" target="_blank" rel="noreferrer">
								<div className="flex items-center gap-3">
									<Icons.inertia className="h-6 w-6" />
									<span className="font-semibold">Inertia.js</span>
								</div>
								<p className="mt-3 text-sm text-muted-foreground">Modern SPA experience with classic server-side routing.</p>
							</a>
							...
							>
								...
								<p className="mt-3 text-sm text-muted-foreground">Optimized SQLAlchemy companion library.</p>
							</a>

							<a href="https://react.dev/" className="group rounded-xl border bg-card p-6 transition-colors hover:bg-accent" target="_blank" rel="noreferrer">
								<div className="flex items-center gap-3">
									<Icons.react className="h-6 w-6" />
									<span className="font-semibold">React 19</span>
								</div>
								<p className="mt-3 text-sm text-muted-foreground">Modern UI with the latest React features.</p>
							</a>
						</div>
